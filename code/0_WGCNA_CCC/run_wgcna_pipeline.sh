...
lr_resource="/projects/bioinformatics/DB/CellCellCommunication/WithEnzymes/cpdb_all_plus_enzymes.csv"
...
if [ $SEPARATE -eq 1 ]; then
    ...
    echo ""
    python /home/lnemati/pathway_crosstalk/code/0_WGCNA_CCC/separate_tissues.py --inputfile "/projects/bioinformatics/DB/Xena/TCGA_GTEX/TCGA_GTEX.h5ad" --outputdir "/projects/bioinformatics/DB/Xena/TCGA_GTEX/by_tissue_primary_vs_normal/"

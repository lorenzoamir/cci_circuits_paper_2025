...
script_dir="/home/lnemati/pathway_crosstalk/code/8.5_immunotherapy_non_cci_cliques/scripts"
result_dir="/home/lnemati/pathway_crosstalk/results/immunotherapy/non_cci_cliques"
...
if [ $TISSUES -eq 1 ] && [ $COHORTS -eq 0 ]; then
    ...
    outdir='/home/lnemati/pathway_crosstalk/results/immunotherapy/non_cci_cliques/features_sets/tissues'
if [ ! -d "$outdir" ]; then
        mkdir "$outdir"
    fi
fi
...
if [ $COHORTS -eq 1 ] && [ $TISSUES -eq 0 ]; then
    cohorts_list=($(find /home/lnemati/pathway_crosstalk/data/immunotherapy/cohorts -name "*.csv"))
    outdir='/home/lnemati/pathway_crosstalk/results/immunotherapy/non_cci_cliques/features_sets/cohorts'
if [ ! -d "$outdir" ]; then
        mkdir "$outdir"
    fi
fi
...
# Find directories with results in /home/lnemati/pathway_crosstalk/results/immunotherapy/non_cci_cliques/tissues
tissues_list=$(find /home/lnemati/pathway_crosstalk/results/immunotherapy/non_cci_cliques/individual_interactions_and_motifs -maxdepth 1 -mindepth 1 -type d)

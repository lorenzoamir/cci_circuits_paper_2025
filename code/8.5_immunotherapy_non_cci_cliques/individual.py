...
if motif == 'individual_ccis':
    ...
    # TODO: REPLACE THIS WITH A LIST OF PSEUDO CCIS!!!!!
    ccc = pd.read_csv('/home/lnemati/pathway_crosstalk/data/interactions/pseudo_ccc_reduced_from_non_cci_cliques.csv')
...
#    results.to_csv(os.path.join(results_dir, 'metrics', 'random_pairs.csv'))
    ...
    # Read motif file
    all_motifs = pd.read_csv('/home/lnemati/pathway_crosstalk/results/crosstalk/all_ccc_complex_pairs/adj/non_cci_cliques/motifs_reduced_for_immunotherapy.csv')
    # Get genes
    ...
    if motifdf.shape[0] > 10000:
        print('Found ', motifdf.shape[0], ' motifs')
        print('Subsetting to 10000 random motifs')
        motifdf = motifdf.sample(n=10000, random_state=seed)

#!/bin/bash
#PBS -N motifs_lining_of_body_cavities_tumor
...
python motifs.py --inputfile /home/lnemati/pathway_crosstalk/data/networks/tumor/lining_of_body_cavities.csv.gz
exit 0

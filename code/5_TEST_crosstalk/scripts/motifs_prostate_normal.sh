...
python motifs.py --inputfile /projects/bioinformatics/DB/Xena/TCGA_GTEX/by_tissue_primary_vs_normal/prostate/normal/prostate/interactions/all_ccc_complex_pairs.csv
exit 0

...
parser = argparse.ArgumentParser(
    description='Get network metrics for standard and partial correlation'
)
...
wgcna_file = args.input

# Replace the filename, use the same folder but correlation.csv.gz
dirname = os.path.dirname(wgcna_file)
...
np.fill_diagonal(pcorr.values, 0)

# Compute network metrics


# name is the last part of the filename after the last / removing initial "wgcna_"
